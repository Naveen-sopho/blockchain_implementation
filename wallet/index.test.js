...
describe('Wallet',()=>{
    ...
    describe('calculating a balance',()=>{
        ...
        it('calculates the balance for blockchain transactions matchng the recipient',()=>{
            expect(wallet.calculateBalance(bc)).toEqual(INITIAL_BALANCE+(addBalance*repeatAdd));
        });

        it('calculates the balance for blockchain transactions matchng the sender',()=>{
        ...
        describe('and the recipient conducts a transaction',()=>{
            ...
            describe('and the sender sends another transaction to the recipient',()=>{
                ...
                it('calculates the recipient balance using only transactions from its most recent one',()=>{
